export default {
  ...
  exerciseMode: {
    ...
    builderDesc: 'Disegna il tuo esercizio sul campo con coni, sagome, frecce e molto altro',
    builderTag: 'Consigliato',
    classic: 'Form rapido',
    classicDesc: 'Inserisci i dettagli manualmente senza schema campo',
  },
  ...
  builder: {
    ...
    pole: 'Paletto',
    smallGoal: 'Porticina',
    rebounder: 'Rete rimbalzo',
    miniPole: 'Mini paletto',
    medicineBall: 'Palla medica',
    gkCatchLow: 'Presa bassa',
    gkCatchFront: 'Presa frontale',
    gkKick: 'Calcio',
    gkDiveLow: 'Parata bassa',
    gkDiveFront: 'Parata frontale',
    catEquipment: 'Attrezzatura',
    catPlayers: 'Giocatori',
    catGoals: 'Porte',
    catMovement: 'Movimento',
    drawMode: 'Disegna',
    drawModeOff: 'Fine disegno',
  ...
  stats: {
    ...
    shotMaps: 'Mappa tiri',
    shotMapsDesc: 'Visualizza le mappe tiri di ogni partita',
  ...
  settings: {
    ...
    feedback: 'Feedback',
    feedbackPlaceholder: 'Scrivi un consiglio o suggerimento...',
    feedbackSend: 'Invia feedback',
    feedbackSent: 'Grazie per il feedback!',
    feedbackEmpty: 'Scrivi qualcosa prima di inviare',
    feedbackList: 'Feedback ricevuti',
    feedbackNoItems: 'Nessun feedback ricevuto',
    adminUsers: 'Utenti registrati',
    adminSubscriptions: 'Abbonamenti attivi',
    adminNoUsers: 'Nessun utente registrato',
    adminNoSubscriptions: 'Nessun abbonamento attivo',
    adminRegistered: 'Registrato',
    logout: 'Esci',
    deleteAccount: 'Elimina account',
    deleteAccountConfirm: 'Eliminare l\'account?',
    deleteAccountMessage: 'Verranno eliminati definitivamente il tuo account e tutti i tuoi dati: le squadre di cui sei allenatore, allenamenti, partite, esercizi e statistiche. L\'operazione è irreversibile.',
    deleteAccountCta: 'Elimina definitivamente',
  ...
  auth: {
    ...
    legalPrefix: 'Registrandoti accetti i',
