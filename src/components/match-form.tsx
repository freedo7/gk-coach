      ...
      await onSubmit(
        {
          ...
          goals_scored: goalsScored.trim() ? parseInt(goalsScored.trim(), 10) : goalsConceded.trim() ? 0 : null,
          goals_conceded: goalsConceded.trim() ? parseInt(goalsConceded.trim(), 10) : goalsScored.trim() ? 0 : null,
          rating: rating > 0 ? rating : null,
          result: null,
